...
function getContextInfo() {
  ...
  if (context.hasDocument) {
    ...
    if (activeLayerRef) {
      ...
      var al = {};
      try { al.name = layer.name; } catch (e) {}
      try { al.kind = String(layer.kind); } catch (e) {}
      try { al.opacity = layer.opacity; } catch (e) {}
      try { al.blendMode = String(layer.blendMode); } catch (e) {}
      try { al.visible = layer.visible; } catch (e) {}
      try { al.locked = layer.allLocked; } catch (e) {}
      try { al.isBackground = layer.isBackgroundLayer; } catch (e) {}
  ...
  getLayerNames: () => `
    ...
    for (var i = 0; i < topCount; i++) {
      try {
        ...
        var row = {};
        try { row.name = layer.name; } catch (e) {}
        try { row.kind = String(layer.kind); } catch (e) {}
        try { row.visible = layer.visible; } catch (e) {}
        try { row.opacity = layer.opacity; } catch (e) {}
        try { row.blendMode = String(layer.blendMode); } catch (e) {}
        layers.push(row);
      } catch (eIter) {}
    }
