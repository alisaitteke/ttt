...
<template>
  <DialogPortal>
    ...
    <DialogContentPrimitive
      ...
      :class="
        cn(
          'fixed left-1/2 top-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 border border-border bg-card px-5 pb-5 pt-3 shadow-lg duration-200 sm:max-w-lg',
